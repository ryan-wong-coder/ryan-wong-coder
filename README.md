...
<a href="https://github.com/binaricat/Netcatty/pull/2413">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="./assets/activity-cards/pr-binaricat-netcatty-2413-be01aa1bd0-dark.svg" />
    <source media="(prefers-color-scheme: light)" srcset="./assets/activity-cards/pr-binaricat-netcatty-2413-be01aa1bd0-light.svg" />
    <img alt="PR MERGED: feat(plugins): add connection, authentication, and importer providers" src="./assets/activity-cards/pr-binaricat-netcatty-2413-be01aa1bd0-light.svg" width="100%" />
  </picture>
</a>
<br />
